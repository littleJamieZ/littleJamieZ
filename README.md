...
**Co-founder · CTO & CPO** at [Aleta Index](https://aletaindex.com) — building the data infrastructure that turns the world's news into credible, structured signal for AI agents and decision-makers.

Designer-engineer. I build the models, the pipeline, and the product.

```python
stack = {
    "ml":    ["Transformers", "LoRA", "Qwen3-Embedding", "FinBERT", "XGBoost"],
    "infra": ["Python", "FastAPI", "PostgreSQL/pgvector", "FAISS", "Docker", "GCP/AWS"],
    "craft": ["design", "product", "user research"],
}
```
